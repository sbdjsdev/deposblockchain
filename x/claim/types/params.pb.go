...
func init() {
	proto.RegisterType((*ClaimAuthorization)(nil), "trdtech.deposnetwork.claim.v1beta1.ClaimAuthorization")
	proto.RegisterType((*Params)(nil), "trdtech.deposnetwork.claim.v1beta1.Params")
}

func init() {
	proto.RegisterFile("deposnetwork/claim/v1beta1/params.proto", fileDescriptor_c219c2c72539a013)
}
...
var fileDescriptor_c219c2c72539a013 = []byte{
	...
	0x20, 0x82, 0x54, 0x6c, 0x35, 0x11, 0x12, 0xea, 0x2e, 0x4e, 0x40, 0x62, 0x81, 0x40, 0x06, 0x84,
	...
	0x93, 0xef, 0xff, 0x0a, 0x00, 0x00, 0xff, 0xff, 0x2b, 0x53, 0xc1, 0x51, 0x69, 0x04, 0x00, 0x00,
}
