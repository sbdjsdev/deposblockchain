...
type MsgClaimFor struct {
	...
	Action  Action `protobuf:"varint,3,opt,name=action,proto3,enum=trdtech.deposnetwork.claim.v1beta1.Action" json:"action,omitempty"`
}
...
func init() {
	proto.RegisterType((*MsgInitialClaim)(nil), "trdtech.deposnetwork.claim.v1beta1.MsgInitialClaim")
	proto.RegisterType((*MsgInitialClaimResponse)(nil), "trdtech.deposnetwork.claim.v1beta1.MsgInitialClaimResponse")
	proto.RegisterType((*MsgClaimFor)(nil), "trdtech.deposnetwork.claim.v1beta1.MsgClaimFor")
	proto.RegisterType((*MsgClaimForResponse)(nil), "trdtech.deposnetwork.claim.v1beta1.MsgClaimForResponse")
}

func init() {
	proto.RegisterFile("deposnetwork/claim/v1beta1/tx.proto", fileDescriptor_9ee4a19153cf6635)
}
...
var fileDescriptor_9ee4a19153cf6635 = []byte{
	...
	0x23, 0x91, 0x5d, 0xdd, 0x45, 0x29, 0x40, 0xa2, 0x48, 0x82, 0x90, 0x52, 0xb8, 0x71, 0x49, 0x13,
	...
	0x71, 0xf2, 0xa9, 0x8f, 0x07, 0x21, 0x64, 0xd6, 0x07, 0x84, 0x6f, 0xaf, 0x3d, 0x91, 0xfd, 0xcd,
	0xec, 0xb8, 0xf2, 0x5a, 0x9c, 0x17, 0xff, 0x84, 0x75, 0xb6, 0xcd, 0xf0, 0xcd, 0xee, 0x4a, 0xc7,
	0x1b, 0x4b, 0xb5, 0x88, 0xf3, 0xec, 0xaf, 0x91, 0xb6, 0xf2, 0x61, 0x78, 0x3e, 0x77, 0xd1, 0xc5,
	...
	0x4d, 0xd4, 0x66, 0xc7, 0x43, 0xbd, 0x7b, 0x7b, 0x7f, 0x02, 0x00, 0x00, 0xff, 0xff, 0x22, 0x91,
	0xd0, 0x56, 0x25, 0x04, 0x00, 0x00,
}
...
func (c *msgClient) InitialClaim(ctx context.Context, in *MsgInitialClaim, opts ...grpc.CallOption) (*MsgInitialClaimResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/trdtech.deposnetwork.claim.v1beta1.Msg/InitialClaim", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) ClaimFor(ctx context.Context, in *MsgClaimFor, opts ...grpc.CallOption) (*MsgClaimForResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/trdtech.deposnetwork.claim.v1beta1.Msg/ClaimFor", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_InitialClaim_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/trdtech.deposnetwork.claim.v1beta1.Msg/InitialClaim",
	}
...
func _Msg_ClaimFor_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/trdtech.deposnetwork.claim.v1beta1.Msg/ClaimFor",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "trdtech.deposnetwork.claim.v1beta1.Msg",
	...
	Metadata: "deposnetwork/claim/v1beta1/tx.proto",
}
