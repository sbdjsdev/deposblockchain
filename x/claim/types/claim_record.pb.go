...
func init() {
	proto.RegisterEnum("trdtech.deposnetwork.claim.v1beta1.Action", Action_name, Action_value)
	proto.RegisterType((*ClaimRecord)(nil), "trdtech.deposnetwork.claim.v1beta1.ClaimRecord")
}

func init() {
	proto.RegisterFile("deposnetwork/claim/v1beta1/claim_record.proto", fileDescriptor_8a75b9157744df4f)
}
...
var fileDescriptor_8a75b9157744df4f = []byte{
	...
	0x88, 0xda, 0x2a, 0x15, 0x1b, 0x76, 0xcd, 0x20, 0x24, 0x90, 0xca, 0x62, 0x8a, 0x58, 0xb0, 0x19,
	...
	0x00, 0xff, 0xff, 0x56, 0x07, 0x5e, 0x89, 0x89, 0x02, 0x00, 0x00,
}
