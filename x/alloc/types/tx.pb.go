...
func init() {
	proto.RegisterType((*MsgCreateVestingAccount)(nil), "trdtech.deposnetwork.alloc.v1beta1.MsgCreateVestingAccount")
	proto.RegisterType((*MsgCreateVestingAccountResponse)(nil), "trdtech.deposnetwork.alloc.v1beta1.MsgCreateVestingAccountResponse")
}

func init() {
	proto.RegisterFile("deposnetwork/alloc/v1beta1/tx.proto", fileDescriptor_8d14330d7694f253)
}
...
func (c *msgClient) CreateVestingAccount(ctx context.Context, in *MsgCreateVestingAccount, opts ...grpc.CallOption) (*MsgCreateVestingAccountResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/trdtech.deposnetwork.alloc.v1beta1.Msg/CreateVestingAccount", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateVestingAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/trdtech.deposnetwork.alloc.v1beta1.Msg/CreateVestingAccount",
	}
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "trdtech.deposnetwork.alloc.v1beta1.Msg",
	...
	Metadata: "deposnetwork/alloc/v1beta1/tx.proto",
}
