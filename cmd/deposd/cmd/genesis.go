...
import (
	...
	minttypes "github.com/trdtech/deposnetwork/x/mint/types"

	// appParams "github.com/trdtech/deposnetwork/app/params"
	"github.com/CosmWasm/wasmd/x/wasm"
	wasmtypes "github.com/CosmWasm/wasmd/x/wasm/types"
	alloctypes "github.com/trdtech/deposnetwork/x/alloc/types"
	claimtypes "github.com/trdtech/deposnetwork/x/claim/types"
)
...
const (
	...
	BaseCoinUnit        = "udepos"
	DeposExponent       = 6
	Bech32PrefixAccAddr = "depos"
)

type Snapshot struct {
	TotalDeposAirdropAmount sdk.Int                    `json:"total_depos_amount"`
...
type SnapshotAccount struct {
	...
	DeposnetworkHubDelegator     bool    `json:"sg_hub_delegator"`
	DeposnetworkOsmosisDelegator bool    `json:"sg_osmosis_delegator"`
	DeposnetworkRegenDelegator   bool    `json:"sg_regen_delegator"`
...
Example:
	deposd prepare-genesis mainnet deposnetwork-1 snapshot.json
	- Check input genesis:
		file is at ~/.deposd/config/genesis.json
`,
...
func MainnetGenesisParams() GenesisParams {
	...
	genParams.AirdropSupply = sdk.NewInt(250_000_000_000_000)              // 250M DEPOS
	genParams.GenesisTime = time.Date(2021, 10, 29, 17, 0, 0, 0, time.UTC) // Oct 29, 2021 - 17:00 UTC

	genParams.NativeCoinMetadatas = []banktypes.Metadata{
		{
			Description: "The native token of DeposNetwork",
	...
	genParams.AllocParams.WeightedDeveloperRewardsReceivers = []alloctypes.WeightedAddress{
		{
			Address: "depos1xqz6xujjyz0r9uzn7srasle5uynmpa0zkjr5l8",
			Weight:  sdk.NewDecWithPrec(33, 2),
		},
		{
			Address: "depos15gp36gk6jvfupy8rc4segppa38lhm3helm5f8k",
			Weight:  sdk.NewDecWithPrec(67, 2).Mul(sdk.NewDecWithPrec(40, 2)),
		},
		{
			Address: "depos168efxgnh55vcgx83x90pw2fves9anw8kmnlsf5",
			Weight:  sdk.NewDecWithPrec(67, 2).Mul(sdk.NewDecWithPrec(30, 2)),
		},
		{
			Address: "depos139a4n6w6dhwv60dj2clgwm6r0q84gju28z9at0",
			Weight:  sdk.NewDecWithPrec(67, 2).Mul(sdk.NewDecWithPrec(30, 2)),
		},
	}
...
func TestnetGenesisParams() GenesisParams {
	...
	genParams.AllocParams.WeightedDeveloperRewardsReceivers = []alloctypes.WeightedAddress{
		// faucet
		{
			Address: "depos1qpeu488858wm3uzqfz9e6m76s5jmjjtcuwr8e2",
			Weight:  sdk.NewDecWithPrec(80, 2),
		},
		{
			Address: "depos1fayut6xzyka29zvznsumlgy5pl4vkn4fkmaznc",
