...
import (
	...
	"github.com/trdtech/deposnetwork/x/mint"
	mintkeeper "github.com/trdtech/deposnetwork/x/mint/keeper"
	...
	"github.com/trdtech/deposnetwork/docs"
	sgwasm "github.com/trdtech/deposnetwork/internal/wasm"
	allocmodule "github.com/trdtech/deposnetwork/x/alloc"
	allocmodulekeeper "github.com/trdtech/deposnetwork/x/alloc/keeper"
	allocmoduletypes "github.com/trdtech/deposnetwork/x/alloc/types"
	claimmodule "github.com/trdtech/deposnetwork/x/claim"
	claimmodulekeeper "github.com/trdtech/deposnetwork/x/claim/keeper"
	claimmoduletypes "github.com/trdtech/deposnetwork/x/claim/types"
	claimwasm "github.com/trdtech/deposnetwork/x/claim/wasm"
)

const (
	AccountAddressPrefix = "depos"
	Name                 = "deposnetwork"
)
...
func init() {
	...
	DefaultNodeHome = filepath.Join(userHomeDir, ".deposd")
}
...
// NewDeposNetworkApp returns a reference to an initialized Gaia.
func NewDeposNetworkApp(
	logger log.Logger,
	db dbm.DB,
	...
	supportedFeatures := "iterator,staking,stargate,deposnetwork"
